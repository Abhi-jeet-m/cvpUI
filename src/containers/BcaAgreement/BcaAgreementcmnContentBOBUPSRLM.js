...
import AnnexureBOBUPSRLM from "./AnnexureBOBUPSRLM";

export default class BcaAgreementcmnContentBOBUPSRLM extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    var bcaannexure;
     ...
     if (docCode === "BCAABOBUPSRLM") {
       bcaannexure = <AnnexureBOBUPSRLM />;
     }
        ...
        <div style={{ fontSize: "15px" }}>
          ...
          <ol type="A">
            ...
            <li>
              ...
              correspondent agent (“BANK SAKHI/Bank Mitra”) and wishes to offer
              ...
              notification dated 1 July 2014. BC Services offered by a BANK
              SAKHI include opening of bank accounts, small value of cash
              ...
              of the Bank. The BANK SAKHI serves in a location, very often in a
              ...
              of technology to carry out the necessary functions. The BANK SAKHI
              functions essentially as an entrepreneur for providing BC
              Services.
            </li>
            <li>
              ...
              intention to function as a BANK SAKHI.
            </li>
            <li>
              ...
              offer the opportunity to the Service Provider as a BANK SAKHI for
            ...
            <li>
              ...
              Corporate Business Correspondents like the Company, BANK SAKHIs
            ...
            <li>
              The Service Provider has been accepted in principle as a BANK
              SAKHI by the Company and the Bank, and has opened the necessary
              commission and settlement accounts as stated in the preamble.
            </li>
          </ol>
          <b>NOW THIS AGREEMENT WITHNESSTH AS FOLLOWS:</b>
          <br />
          <b>1. Empanelment of BANK SAKHI</b>
          <ol type="a">
            <li>
              ...
              hereby empanelled to carry out BC Services for the Bank as a BANK
              SAKHI, following the necessary verification and approval by the
              Bank.
            </li>
            <li>
          ...
          <p>
            ...
            operations by the Bank Branch and BANK SAKHI providing risk coverage
          ...
          <p>
            The roles and responsibilities of the Service Provider as a BANK
            SAKHI shall consist of the following:
          </p>
          <ol type="a">
            <li>
              The BANK SAKHI shall carry out BC Services from the BC Outlet.
            </li>
            <li>
            ...
            <li>
              The BANK SAKHI shall bear the cost relating to the rent,
            ...
            <li>
              Besides operating out of the BC Outlet, the BANK SAKHI would
              undertake periodic visits to the associated neighbouring
              villages/wards to serve customers of the Bank.
            </li>
            <li>
              The BANK SAKHI shall provide services as stated under PMJDY and
              such other schemes as defined by the Bank from time to time.
            </li>
            <li>
              The BANK SAKHI shall offer the services to the customers/potential
            ...
            <li>
              The BANK SAKHI shall provide services to customers without any
              discrimination based on gender, caste, creed, religion, region,
              economic status etc.
            </li>
            <li>
              The BANK SAKHI shall not accept/demand any money from customers
              for any services in addition to what is stipulated by the Bank.
            </li>
            <li>
              The BANK SAKHI will not carry out business of money lending or
              ...
              once working as a BANK SAKHI. 
            </li>
            <li>
              The BANK SAKHI shall not indulge in any manipulative transaction,
              either by self or in collusion with others—all transactions must
              necessarily be carried out in the BANK SAKHI’s presence and with
            ...
            <li>
              Fund management – The BANK SAKHI shall maintain adequate funds for
              customer transactions. The BANK SAKHI shall plan on a daily basis
              for adequate cash in hand for customer withdrawals and adequate
              balance in the BANK SAKHI settlement account for customer cash
              deposits, especially taking into account events like festivals or
              disbursal of benefits in the BC Location and banking needs/habits
              of customers. The BANK SAKHI shall deposit any net surplus cash in
              a timely manner at the Bank branch and shall maintain up-to-date
              balances. The BANK SAKHI shall return undistributed funds provided
              to theBANK SAKHI for disbursement, along with necessary documents,
              to the Bank branch within the specified period.
            </li>
            <li>
              The BANK SAKHI shall maintain records of all transactions as
              required for BC operations. The BANK SAKHI will provide full
            ...
            <li>
              The BANK SAKHI shall invest capital on the BC Outlet to enhance
              customer experience, increase customer transactions and thereby
              earn higher commission. The BANK SAKHI shall invest in
              infrastructure required for transactions as and when required by
              the Bank.
            </li>
            <li>
              The BANK SAKHI understands and agrees that the earnings in terms
              ...
              Commission to the BANK SAKHI is subject to the payment of
              Commission to the Company by the Bank.
            </li>
            <li>
              The BANK SAKHI shall represent and provide banking services of one
              bank only. The BANK SAKHI shall carry out all necessary roles,
              including scouting for customers, popularizing schemes, updating
              information about the region, carrying out BC Services, planning
              time of services when needed and visiting places to maximize the
              Commission and customer loyalty. The BANK SAKHI shall be prepared
              to carry out other related transactions including
              e-mart/electronic commerce as directed by the Bank.
            </li>
            <li>
              The BANK SAKHI shall strive to achieve customer satisfaction,
              operational trust, transparency and fulfilment of obligations.
            </li>
            <li>
              The BANK SAKHI shall attend and participate in meetings as and
              when called by the Bank/Company officials on the BANK SAKHI’s own
              cost.
            </li>
            <li>
              The BANK SAKHI will maintain high standards of compliances of the
              ...
              for cash deposit/withdrawal can be used by the BANK SAKHI. No
              manual update of Passbook can be done. No Term
              deposit/Fixed/RD/bond/Fund Certificates can be issued by the BANK
              SAKHI to any customer. The BANK SAKHI must protect the trust of
            ...
            <li>
              ...
              money brokerage or agent of another institution for money lending
              by himself/herself or through his family under any circumstances,
              once empanelled as a BANK SAKHI. Also, the BANK SAKHI is not
              allowed to work as an agent for any other bank /aggregators
              /distributor as per the regulations of RBI.
            </li>
            <li>
              The BANK SAKHI will maintain basic hygiene of the operations –
            ...
            <li>
              The BANK SAKHI will accept customer cash within the limits of
              online transaction only; the limits are specified by the Bank from
              time to time.
            </li>
            <li>
              The BANK SAKHI will show high standards of honesty and integrity
            ...
            <li>
              The BANK SAKHI will always explain the customer whenever the thumb
              print is taken. Under no circumstances, the BANK SAKHI will take
              finger print repeatedly without showing the printed receipt which
              states error in previous transaction.
            </li>
            <li>
              The BANK SAKHI will maintain all records such as registers, any
            ...
            <li>
              The BANK SAKHI understands that any breach in operations or trust
            ...
            <span>
              The BANK SAKHI shall not misbehave with customers/Bank
              officials/Company officials at any point of time.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>bb.</span>
            <span>
              The BANK SAKHI shall hold all customer data, financial,
              commercial, technical and/or all proprietary information relating
              to the Company and/or the Bank made available to the BANK SAKHI
              either orally or in writing or any other information disclosed to
              the BANK SAKHI(“Confidential Information”) as strictly
              confidential. The BANK SAKHI shall use such Conial Information
            ...
            <span>
              The BANK SAKHI shall inform immediately the Company or the Bank of
              any unusual results of any operations and shall not take advantage
              of such situation. The BANK SAKHI shall not resort to
            ...
            <span>
              The BANK SAKHI authorizes the Company to consider the amount of
              Commission computed by the Bank for the BANK SAKHI
              transactions/operations for the month as the Commission amount
              invoiced by the BANK SAKHI on the Company for the month. The BANK
              SAKHI agrees that the Company shall remit the Commission amount to
              the BANK SAKHI Bank Account for Commission as stated in the
              preamble after deducting appropriate taxes.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>ee.</span>
            <span>
              The BANK SAKHI is an entrepreneur, whether with or without any
            ...
            <span>
              The BANK SAKHI undertakes to retire from empanelment automatically
              if the number of failures to meet minimum service levels in any
              given time period exceeds the limit specified by the Bank.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>gg.</span>
            <span>
              The BANK SAKHI authorizes the Company and/or the Bank to access
              the saving bank account of the BANK SAKHI. The BANK SAKHI hereby
              consents to appropriate the properties in name of BANK SAKHI and
              search/seizure house of the BANK SAKHI if found suspected of
          ...
          <ol type="a">
            <li>
              ...
              the criteria laid down by the Bank and on the business the BANK
              SAKHI generates for the Bank. The Commission is normally
            ...
            <li>
              ...
              he/she has a BANK SAKHI fails to: (i) build/expand the customer
            ...
            <li>
              ...
              monthly basis. The amount will be transferred to the BANK SAKHI
          ...
          <p>
            ...
            Service Provider as a BANK SAKHI by the Company is based on this
          ...
          <p>
            The obligations of the Service Provider as a BANK SAKHI under this
          ...
          <p>
            ...
            the role of the Service Provider as a BANK SAKHI requires the BANK
            SAKHI to authenticate transactions, by biometrics or otherwise, and
