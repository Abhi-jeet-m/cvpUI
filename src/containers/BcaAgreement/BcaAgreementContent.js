...
class BcaAgreementContent extends Component{
    constructor(){
        super();
    ...
    render(){
        return(
            <div style={{fontFamily : "Times New Roman"}}>
                ...
                <li>H The Service Provider has been accepted in principle as a BCA by the Company and the Bank, and has opened the necessary commission and settlement accounts as stated in the preamble.</li>
                </ol>
...
export default BcaAgreementContent