...
import AnnexureUJVN from "./AnnexureUJVN";
import AnnexureBRKGB from "./AnnexureBRKGB";


export default class BcaAgreementcmnContentUJVN extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    var bcaannexure;
     ...
     if (docCode === "BCAAUJVN") {
       bcaannexure = <AnnexureUJVN />;
     }
      if(docCode === "BCAABRKGB"){
        // bcaannexure = <AnnexureUJVN />;
      bcaannexure = <AnnexureBRKGB />;
     }
        ...
        <div style={{ fontSize: "15px" }}>
          ...
          <ol type="A">
            ...
            <li>
              ...
              correspondent agent (“Money Mitra/Bank Mitra”) and wishes to offer
              ...
              notification dated 1 July 2014. BC Services offered by a Money
              Mitra include opening of bank accounts, small value of cash
              deposits, small value of cash withdrawals, small value of transfer
              of funds, disbursement, collections, balance enquiries and mini
              statements, seeding, sale of insurance and pension products, bill
              payments, deposit/savings/credit mobilization, and business
              facilitator functions such as recovery and credit lead generation,
              with a scope for adding other services in the future for customers
              of the Bank. The Money Mitra serves in a location, very often in a
              rural area that might comprise one or more villages, where it is
              not feasible to have a branch of the Bank, and relies on the usage
              of technology to carry out the necessary functions. The Money
              Mitra functions essentially as an entrepreneur for providing BC
              Services.
            </li>
            <li>
              ...
              intention to function as a Money Mitra.
            </li>
            <li>
              ...
              offer the opportunity to the Service Provider as a Money Mitra for
              the Bank in the BC Location as stated in the preamble (“BC
              Location”) for delivering BC Services as defined by the BC
              sub-agent model of the RBI and offered under the Pradhan Mantri
              Jan-Dhan Yojana (“PMJDY”) of the Govt. of India and other schemes
              of the Bank.
            </li>
            <li>
            ...
            <li>
              ...
              Corporate Business Correspondents like the Company, Money Mitras
              and other associated entities have to deal frequently with changes
              in technology and also with changes in policies of Government
              bodies and Banks. Both the Parties are fully aware of the risks
              associated with this evolving field and accept the same.
            </li>
            <li>
              The Service Provider has been accepted in principle as a Money
              Mitra by the Company and the Bank, and has opened the necessary
              commission and settlement accounts as stated in the preamble.
            </li>
          </ol>
          <b>NOW THIS AGREEMENT WITHNESSTH AS FOLLOWS:</b>
          <br />
          <b>1. Empanelment of Money Mitra</b>
          <ol type="a">
            <li>
              ...
              hereby empanelled to carry out BC Services for the Bank as a Money
              Mitra, following the necessary verification and approval by the
              Bank.
            </li>
            <li>
          ...
          <p>
            ...
            operations by the Bank Branch and Money Mitra providing risk
            coverage through a guarantee based on the value of transactions
            unless terminated for any reason whatsoever as stated hereinafter
            under Section 13.
          </p>
          ...
          <p>
            The roles and responsibilities of the Service Provider as a Money
            Mitra shall consist of the following:
          </p>
          <ol type="a">
            <li>
              The Money Mitra shall carry out BC Services from the BC Outlet.
            </li>
            <li>
            ...
            <li>
              The Money Mitra shall bear the cost relating to the rent,
              infrastructure, equipment, electricity charges, Internet charges,
              travel expenses etc. The Company shall not be responsible for
              bearing any of these costs nor shall it be responsible for
              fulfilling any loan/obligations undertaken by the Service Provider
              in this regard.
            </li>
            <li>
            ...
            <li>
              Besides operating out of the BC Outlet, the Money Mitra would
              undertake periodic visits to the associated neighbouring
              villages/wards to serve customers of the Bank.
            </li>
            <li>
              The Money Mitra shall provide services as stated under PMJDY and
              such other schemes as defined by the Bank from time to time.
            </li>
            <li>
              The Money Mitra shall offer the services to the
              customers/potential customers of the Bank keeping in mind the
              business ethics, value systems, confidentiality of data, security
              of information, and reputation of the Bank and the Company.
            </li>
            <li>
              The Money Mitra shall provide services to customers without any
              discrimination based on gender, caste, creed, religion, region,
              economic status etc.
            </li>
            <li>
              The Money Mitra shall not accept/demand any money from customers
              for any services in addition to what is stipulated by the Bank.
            </li>
            <li>
              The Money Mitra will not carry out business of money lending or
              money brokerage or agent of another institution for money lending
              by himself/herself or through his family under any circumstances,
              once working as a Money Mitra. 
            </li>
            <li>
              The Money Mitra shall not indulge in any manipulative transaction,
              either by self or in collusion with others—all transactions must
              necessarily be carried out in the Money Mitra’s presence and with
              customer authentication in the customer’s presence and routed
              through the designated BC machine/device. Additionally, all cash
              transactions (transactions involving cash deposit, withdrawal,
              transfer, payment etc) will be carried out only through the
              designated BC machine/device.
            </li>
            <li>
              Fund management – The Money Mitra shall maintain adequate funds
              for customer transactions. The Money Mitra shall plan on a daily
              basis for adequate cash in hand for customer withdrawals and
              adequate balance in the Money Mitra settlement account for
              customer cash deposits, especially taking into account events like
              festivals or disbursal of benefits in the BC Location and banking
              needs/habits of customers. The Money Mitra shall deposit any net
              surplus cash in a timely manner at the Bank branch and shall
              maintain up-to-date balances. The Money Mitra shall return
              undistributed funds provided to the Money Mitra for disbursement,
              along with necessary documents, to the Bank branch within the
              specified period.
            </li>
            <li>
              The Money Mitra shall maintain records of all transactions as
              required for BC operations. The Money Mitra will provide full
              cooperation in producing all records (including any document,
              cards, passbook, or any document taken from customers, registers
              logging the transactions) needed for carrying out compliance Audit
              of operations periodically by the Bank or by the Company.
            </li>
            <li>
              The Money Mitra shall invest capital on the BC Outlet to enhance
              customer experience, increase customer transactions and thereby
              earn higher commission. The Money Mitra shall invest in
              infrastructure required for transactions as and when required by
              the Bank.
            </li>
            <li>
              The Money Mitra understands and agrees that the earnings in terms
              of commission (the “Commission”) by him/her requires a minimum
              ...
              Commission to the Money Mitra is subject to the payment of
              Commission to the Company by the Bank.
            </li>
            <li>
              The Money Mitra shall represent and provide banking services of
              one bank only. The Money Mitra shall carry out all necessary
              roles, including scouting for customers, popularizing schemes,
              updating information about the region, carrying out BC Services,
              planning time of services when needed and visiting places to
              maximize the Commission and customer loyalty. The Money Mitra
              shall be prepared to carry out other related transactions
              including e-mart/electronic commerce as directed by the Bank.
            </li>
            <li>
              The Money Mitra shall strive to achieve customer satisfaction,
              operational trust, transparency and fulfilment of obligations.
            </li>
            <li>
              The Money Mitra shall attend and participate in meetings as and
              when called by the Bank/Company officials on the Money Mitra’s own
              cost.
            </li>
            <li>
              The Money Mitra will maintain high standards of compliances of the
              ...
              for cash deposit/withdrawal can be used by the Money Mitra. No
              manual update of Passbook can be done. No Term
              deposit/Fixed/RD/bond/Fund Certificates can be issued by the Money
              Mitra to any customer. The Money Mitra must protect the trust of
              the customer in the banking system by ensuring online transactions
              with proper system generated receipt for the customer.
            </li>
            <li>
              The Money Mitra will not carry out business of money lending or
              money brokerage or agent of another institution for money lending
              by himself/herself or through his family under any circumstances,
              once empanelled as a Money Mitra. Also, the Money Mitra is not
              allowed to work as an agent for any other bank /aggregators
              /distributor as per the regulations of RBI.
            </li>
            <li>
              The Money Mitra will maintain basic hygiene of the operations –
              will not accept cash offline from any bank customer for depositing
              into Bank branch or for creating any Bank instrument (draft/RD/FD
              etc). Money can only be taken by transaction on the machine online
              generating receipt coming from core system of the Bank.
            </li>
            <li>
              The Money Mitra will accept customer cash within the limits of
              online transaction only; the limits are specified by the Bank from
              time to time.
            </li>
            <li>
              The Money Mitra will show high standards of honesty and integrity
              by protecting personal data of the customer including
              fingerprints. He/she will not use the information to
              misappropriate funds from the customer accounts directly or in
              collusion with any present or past bank staff.
            </li>
            <li>
              The Money Mitra will always explain the customer whenever the
              thumb print is taken. Under no circumstances, the Money Mitra will
              take finger print repeatedly without showing the printed receipt
              which states error in previous transaction.
            </li>
            <li>
              The Money Mitra will maintain all records such as registers, any
              customers documents including ATM cards, passbooks, enrolment
              forms etc his own Bank account during the visit of a field
              coordinator or Bank staff and fully cooperate in Audit/Compliance
              checks on the operations.
            </li>
            <li>
              The Money Mitra understands that any breach in operations or trust
              of the customer in banking or operational compliances is observed,
              the legal proceedings will be initiated against him/her by the
              company/Bank.
            </li>

            <span style={{ marginLeft: "-12px" }}>aa.</span>
            <span>
              The Money Mitra shall not misbehave with customers/Bank
              officials/Company officials at any point of time.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>bb.</span>
            <span>
              The Money Mitra shall hold all customer data, financial,
              commercial, technical and/or all proprietary information relating
              to the Company and/or the Bank made available to the Money Mitra
              either orally or in writing or any other information disclosed to
              the Money Mitra(“Confidential Information”) as strictly
              confidential. The Money Mitra shall use such Conial Information
              only for the authorized purpose as per this Agreement. All
              customer data (KYC, transactions etc) is deemed confidential.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>cc.</span>
            <span>
              The Money Mitra shall inform immediately the Company or the Bank
              of any unusual results of any operations and shall not take
              advantage of such situation. The Money Mitra shall not resort to
            ...
            <span>
              The Money Mitra authorizes the Company to consider the amount of
              Commission computed by the Bank for the Money Mitra
              transactions/operations for the month as the Commission amount
              invoiced by the Money Mitra on the Company for the month. The
              Money Mitra agrees that the Company shall remit the Commission
              amount to the Money Mitra Bank Account for Commission as stated in
              the preamble after deducting appropriate taxes.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>ee.</span>
            <span>
              The Money Mitra is an entrepreneur, whether with or without any
              other occupation, and is responsible for tax planning,
              insurance(health/life/BC Outlet/equipment) etc.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>ff.</span>
            <span>
              The Money Mitra undertakes to retire from empanelment
              automatically if the number of failures to meet minimum service
              levels in any given time period exceeds the limit specified by the
              Bank.
            </span>
            <br></br>
            <span style={{ marginLeft: "-12px" }}>gg.</span>
            <span>
              The Money Mitra authorizes the Company and/or the Bank to access
              the saving bank account of the Money Mitra. The Money Mitra hereby
              consents to appropriate the properties in name of Money Mitra and
              search/seizure house of the Money Mitra if found suspected of
              committing fraud or found guilty of fraud, provided the Company
              and/or Bank follows the procedure of law.
            </span>
          </ol>
          ...
          <ol type="a">
            <li>
              ...
              the criteria laid down by the Bank and on the business the Money
              Mitra generates for the Bank. The Commission is normally
              applicable only if minimum service has been carried out
              (threshold) as defined by the Bank from time to time.
            </li>
            <li>
            ...
            <li>
              ...
              he/she has a Money Mitra fails to: (i) build/expand the customer
              base; (ii) improve customer relations; (iii) provide services when
              and where needed as already stated hereinabove under Section 3; or
              for any other reason that results in inadequate Commission.
            </li>
            <li>
            ...
            <li>
              ...
              monthly basis. The amount will be transferred to the Money Mitra
              Bank Account for Commission as stated in the preamble once the
              Company receives the payment from the Bank.
            </li>
            <li>
          ...
          <p>
            ...
            Service Provider as a Money Mitra by the Company is based on this
          ...
          <p>
            The Service Provider shall indemnify, defend and hold the Company
            and the Bank harmless from any loss or damage and/or claims by third
            parties for personal injury or property damage caused by the Service
            Provider’s negligent or fraudulent act, omission or willful
            misconduct while rendering the BC Services under this Agreement.
          </p>
          <p>
            Without prejudice to its other rights, the Company reserves the
            right to set off or adjust dues or loss suffered by it on account of
            breach or non-compliance of the terms of this Agreement by the
            Service Provider, from any deposit amount placed by the Service
          ...
          <p>
            The obligations of the Service Provider as a Money Mitra under this
          ...
          <p>
            ...
            the role of the Service Provider as a Money Mitra requires the Money
            Mitra to authenticate transactions, by biometrics or otherwise, and
