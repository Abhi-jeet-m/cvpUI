...
export default class BcaAgreementcmnContent extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    var bcaannexure;
    // if (docCode === "BCAAANDB") {
    //   bcaannexure = <AnnexureEAND />;
    // } else if (docCode === "BCAAUBIN") {
    //   bcaannexure = <AnnexureUBIN />;
    // } else if (docCode === "BCAAKAGB") {
    //   bcaannexure = <AnnexureKGB />;
    // } else if (docCode === "BCAAKVGB") {
    //   bcaannexure = <AnnexureKVGB />;
    // } else if (docCode === "BCAASBIN") {
    //   bcaannexure = <AnnexureSBIN />;
    // } else if (docCode === "BCAAPUNB") {
    //   bcaannexure = <AnnexurePUNB />;
    // } 
      ...
      <div style={{ fontFamily: "Times New Roman" }}>
        ...
        <div style={{ fontSize: "15px" }}>
          ...
          <p>
            ...
            1956, having its registered office at G-5, Swiss Complex, 33, Race
            Course Road, Bangalore - 560001, hereinafter referred to as the
            “Company”, which expression shall unless repugnant to the context or
            meaning thereof, include its subsidiaries, branches, affiliates,
            associate companies, successors in office and permitted assignees
            from time to time, of the First Part;
          </p>
          <b>And</b>
          <p>
          ...
          <p>
            ...
            months or for a period of the police verification is valid,
            whichever is earlier. At the end of this period, the Agreement shall
            be renewed by a further period of twelve (12) months or for a period
            of the police verification is valid, whichever is earlier upon
            submission of police verification, endorsement of satisfactory
            operations by the Bank Branch and BCA providing risk coverage
            through a guarantee based on the volume of transactions unless
          ...
          <ol type="a">
            ...
            <li>
              ...
              in writing or any other information disclosed to the BCA
              (“Confidential Information”) as strictly confidential. The BCA
              shall use such Confidential Information only for the authorized
              purpose as per this Agreement. All customer data (KYC,
              transactions etc) is deemed confidential.{" "}
            </li>
            <li>
            ...
            <li>
              ...
              occupation, and is responsible for tax planning, insurance
              (health/life/BC Outlet/equipment) etc.
            </li>
            <li>
            ...
            <li>
              The BCA authorizes the Company and/or the Bank to access the
              savings bank account of the BCA. The BCA hereby consents to
              appropriate the properties in name of BCA and search/seizure house
              of the BCA if found suspected of committing fraud or found guilty
              of fraud, provided the Company and/or Bank follows the procedure
              of law.
            </li>
          </ol>
        ...
        >
          <tbody>
            <tr>
              <td>
                <b>Integra Micro Systems Private Limited</b>
              </td>
              <td>
