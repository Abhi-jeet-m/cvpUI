...
export default class BcaAgreementContentUBIN extends Component{
    constructor(){
        super();
    ...
    render(){
        return(
            ...
            <div style={{fontFamily : "Times New Roman"}}>
                ...
                <b>WHEREAS</b>
                <ol type="A">
                <li>The Company provides, inter alia, technology products and services to several banks under the national financial inclusion (FI) programme.</li>
                ...
                <b>2. Term</b>
                    <p>This Agreement shall commence on the Effective Date as stated in the preamble and shall remain in force for a period of twelve (12) months or for a period of the police verification is valid, whichever is earlier. At the end of this period, the Agreement shall be renewed by a further period of twelve (12) months or for a period of the police verification is valid, whichever is earlier upon submission of police verification, endorsement of satisfactory operations by the Bank Branch and BCA providing risk coverage through a guarantee based on the volume of transactions unless terminated for any reason whatsoever as stated hereinafter under Section 13.</p> 
                ...
                <ol type="a">
                    ...
                    <li>The BCA will not carry out business of money lending or money brokerage or agent of another institution for money lending by himself/herself or through his family under any circumstances, once working as a BCA. </li>
                    ...
                    <li>The BCA shall maintain records of all transactions as required for BC operations. The BCA will provide full cooperation in producing all records (including any document, cards, passbook, or any document taken from customers, registers logging the transactions) needed for carrying out compliance Audit of operations periodically by the Bank or by the Company.</li>
                    ...
                    <li>The BCA authorizes the Company and/or the Bank to access the savings bank account of the BCA. The BCA hereby consents to appropriate the properties in name of BCA and search/seizure house of the BCA if found suspected of committing fraud or found guilty of fraud, provided the Company and/or Bank follows the procedure of law.</li>
                </ol>
                ...
                <b>7. Insurance</b>
                <p>The Service Provider shall maintain, at its own expense, sufficient insurance coverage to meet obligations created by this Agreement. The coverage amount may be specified at the time of renewal.</p>
                <b>8. Guarantee</b>
                <ol type="a">
                <li>The Service Provider shall identify the guarantor, who shall execute the guarantor agreement. The guarantor has agreed to guarantee the obligations of the Service Provider and to secure any monetary liabilities/damages raised against the Company due to the act and/or omission of the Service Provider under the scope of this Agreement.</li>
                <li>If this Agreement is terminated for any reason whatsoever, the guarantee securing the liabilities/damages may be invoked forthwith in order to pay the monetary liabilities/damages owed by the Company.</li>
                </ol>
