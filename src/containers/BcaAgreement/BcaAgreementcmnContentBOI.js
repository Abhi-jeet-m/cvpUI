...
export default class BcaAgreementcmnContentBOI extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    var bcaannexure;
    if (docCode === "BCAABOI") {
      bcaannexure = <AnnexureBOI />;
    } else if (docCode === "BCAAALLA") {
      bcaannexure = <AnnexureALLA />;
    } else if (docCode === "BCAAANDB") {
    ...
    } else if (docCode === "BCAAECORP") {
      bcaannexure = <AnnexureECORP />;
      officeLocation = "Central";
      officeName = "i25 Outreach Private Limited (CIN: U93090KA2008PTC045806)";
      bcCellSigningAuthority = "i25 Outreach Private Limited";
    } else if (docCode === "BCAACBIN") {
      bcaannexure = <AnnexureCBIN />;
      officeLocation = "Central";
    } else if (docCode === "BCAABOBFI") {
      bcaannexure = <AnnexureBOB />;
    } else if (docCode === "BCAAUCO") {
      bcaannexure = <AnnexureUCO />;
    } else if (docCode === "BCAAKVBL") {
      bcaannexure = <AnnexureKVBL />;
    } else if (docCode === "BCAALAVB") {
      bcaannexure = <AnnexureLAVB />;
    } else if (docCode === "BCAAARYB") {
      bcaannexure = <AnnexureARYB />;
    } else if (docCode === "BCAATMBL") {
      bcaannexure = <AnnexureTMBL />;
      officeLocation = "head";
      officeName = "i25 Outreach Private Limited (CIN: U93090KA2008PTC045806)";
      bcCellSigningAuthority = "i25 Outreach Private Limited";
    } else if (docCode === "BCAAIOB") {
      //  officeLocation = "head";
      bcaannexure = <AnnexureIOB />;
    }
    else if (docCode === "BCAABRKGB") {
      bcaannexure = <AnnexureBRKGB />;
    }

    else if (docCode === "BCAAPSB") {
      bcaannexure = <AnnexurePSB />;
    }
        ...
        <div style={{ fontSize: "15px" }}>
          ...
          <ol type="a">
            ...
            <span>
              ...
              saving bank account of the BCA. The BCA hereby consents to
